...
class RunParams:
	...
	def parse_params(self):
		...
		self.server = args.s
		(self.project, selfsprint) = args.project_sprint.split(":")
...
class Issue:
	...
	def get_estimate_in_story_points(self):
		return(self.estimate_in_story_points)
...
class Project:
	...
	def __init__(self, jira, project_string):
		try:
			...
			self.issues = jira.search_issues(jql_str)
		except JIRAError as e:
